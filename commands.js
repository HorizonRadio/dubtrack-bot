...
function regCommands(commandManager) {
    ...
    [
        ...
        new Command('givedememotes', ['gde', 'givedememotes'], 1, [], [],
             ...
             */
            function(utils) {
                utils.BOT.sendChat(utils.getTargetName() + ' You can download _give dem emotes_ at https://gde.netux.site');
        ...
        new Command('setimgtime', ['setimgtime', 'setimagetime', 'imgtime'], 0, ['mod'], [],
            /**
             * @param {MessageUtils} utils
             */
            function(utils) {
