...
function punishUser(punishData, callback) {
    ...
    const sendMessage = punishData.sendMessage;
    const reason = punishData.reason;
    ...
    const waitAndDoPunishment = () => setTimeout(function() {
        ...
        const punishmentStringArgs = [type, user, mod, time, reason];
...
BotUtils.prototype.timeMute = function(user, mod, time, sendMessage, reason, callback) {
...
BotUtils.prototype.timeBan = function(user, mod, time, sendMessage, reason, callback) {
    punishUser.call(this, {
        type: 'ban',
        user,
        mod,
...
BotUtils.prototype.banUser = function(user, mod, sendMessage, reason, callback) {
    punishUser.call(this, {
        type: 'ban',
        user,
        mod,
...
BotUtils.prototype.kickUser = function(user, mod, sendMessage, reason, callback) {
    punishUser.call(this, {
        type: 'kick',
        user,
        mod,
...
BotUtils.prototype.timeoutUser = function(user, mod, time, reason) {
    this.clearUserChat(user);
    this.timeMute(user, mod, time, true, reason)
};
